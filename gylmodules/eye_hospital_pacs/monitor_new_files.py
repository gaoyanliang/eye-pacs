    ...
    try:
        ...
        if str(ext).lower().__contains__('pdf'):
            if basename.startswith("202"):
                basename = "角膜内皮细胞报告"
                machine = "角膜内皮显微镜"
            elif basename.startswith("203"):
                basename = "角膜地形图"
                machine = "Medmont"
            elif basename.startswith("204"):
                basename = "蔡司检查"
                machine = "蔡司"
            elif basename.startswith("205"):
                basename = "生物力学"
                machine = "非接触式眼压计"
            elif basename.startswith("4"):
                basename = "屈光四图"
                machine = "眼前节分析仪"
            elif basename.startswith("5"):
                basename = "屈光六图"
                machine = "眼前节分析仪"
            elif basename.startswith("1"):
                basename = "干眼分析1"
                machine = "角膜地形图仪"
            elif basename.startswith("2"):
                basename = "干眼分析2"
                machine = "角膜地形图仪"
            elif basename.startswith("3"):
                basename = "干眼分析3"
                machine = "角膜地形图仪"
